...
export type EhrAuditAction =
  ...
  | 'patient_checkin.viewed_trend'
  | 'patient_checkin.reminder_pref_updated'
  | 'group_session.attendance_recorded'
  | 'group_session.member_note_added'
  | 'group_session.plan_updated'
  | 'custom_assessment.template_created'
  | 'custom_assessment.template_updated'
  | 'custom_assessment.template_disabled'
  | 'custom_assessment.administered'
  | 'signals.ingested'
  | 'predictions.computed'
  | 'prediction.viewed'
  | 'prediction.overridden'
  | 'productivity_report.viewed'
  | 'billing_reconciliation.viewed'
  | 'billing_reconciliation.exported'
  | 'patient_relationship.added'
  | 'patient_relationship.removed'
  | 'patient_relationship.viewed'
  | 'note_template.created'
  | 'note_template.updated'
  | 'note_template.deleted'
  | 'note_template.used'
  ...
  // Wave 52 — outcomes / e-sign / reconciliation
  | 'document_template.list'
  | 'document_template.created'
  | 'document_template.updated'
  | 'document_template.archived'
  | 'document.sent'
  | 'document.viewed'
  | 'document.signed'
  | 'document.withdrawn'
  | 'assessment.administered_in_call'
  | 'assessment.sent'
  | 'assessment.completed'
  | 'assessment.crisis_triggered'
  | 'assessment.list'
  | 'assessment.viewed'
  | 'outcomes.summary_viewed'
  | 'outcomes.patient_viewed'
  | 'behavioral_metrics.viewed'
  | 'era.received'
  | 'era.auto_matched'
  | 'era.manually_matched'
  | 'era.disputed'
  | 'era.payment_posted'
  | 'receptionist_funnel.viewed'
  // Wave 50 — moat + wiring.
...
export type PortalAuditAction =
  ...
  | 'portal.checkin.completed'
  | 'portal.checkin.reminder_opted_out'
