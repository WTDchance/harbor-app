...
export default function LandingPage() {
  ...
  // Derive display values — default to "20 spots" while loading.
  const cap = fc?.cap ?? 20
      ...
      <section className="bg-gradient-to-br from-teal-600 to-teal-800 text-white px-6 py-24 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/signup" className="bg-white text-teal-700 px-8 py-3.5 rounded-xl font-semibold text-lg hover:bg-teal-50 transition-colors">
          ...
          <p className="text-teal-300 mt-6 text-sm">{heroSub}</p>
        </div>
      </section>
      ...
      <section className="px-6 py-20">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <blockquote className="text-xl text-gray-700 italic mb-6">
            &ldquo;I used to miss 3–4 calls a week. Now Ellie handles everything – she even screens new patients with mental health questions before I meet them. It&apos;s like having a full-time receptionist for a fraction of the cost.&rdquo;
          </blockquote>
        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          {isFoundingAvailable ? (
            <div className="bg-orange-50 border border-orange-200 rounded-2xl p-4 mb-8">
              <p className="text-orange-700 font-semibold text-sm">
                🎯 Founding Practice Offer – {spotsCopy}
              </p>
              <p className="text-orange-600 text-sm mt-1">
                Lock in ${foundingDollars}/mo forever – only {cap} spots available. Price never increases, even as we add features.
              </p>
            </div>
          ) : (
            <div className="bg-gray-50 border border-gray-200 rounded-2xl p-4 mb-8">
              <p className="text-gray-700 font-semibold text-sm">
                Founding spots have sold out
              </p>
              <p className="text-gray-500 text-sm mt-1">
                Thank you to our founding practices! Regular pricing of ${regularDollars}/mo is now in effect.
              </p>
            </div>
          )}
          ...
          <div className="border-2 border-teal-500 rounded-2xl p-10 shadow-lg relative">
            <div className="absolute -top-4 left-1/2 -translate-x-1/2">
              <span className="bg-teal-500 text-white text-xs font-bold px-4 py-1.5 rounded-full uppercase tracking-wide">
            ...
            <div className="mt-2 mb-2">
              {isFoundingAvailable ? (
                <>
                  ...
                  <span className="text-6xl font-bold text-gray-900">${foundingDollars}</span>
                  <span className="text-gray-500 text-xl">/month</span>
                </>
              ) : (
                <>
                  <span className="text-6xl font-bold text-gray-900">${regularDollars}</span>
                  <span className="text-gray-500 text-xl">/month</span>
                </>
              )}
            </div>
            <p className="text-gray-500 mb-8">
              {isFoundingAvailable
                ? 'Locked in forever for founding practices'
