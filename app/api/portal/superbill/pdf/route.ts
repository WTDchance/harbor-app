// app/api/portal/superbill/pdf/route.ts
//
// Wave 38 / TS7 — patient-portal version of the superbill PDF generator.
//
// Authenticated against the portal session (the patient themselves), and
// scoped strictly to that patient's own charges. Otherwise mirrors the
// therapist-side /api/ehr/billing/superbill/pdf route.
...
export async function GET(req: NextRequest) {
  ...
  await auditPortalAccess({
    session: sess,
    action: 'portal.superbill.generate',
