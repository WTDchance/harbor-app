...
function buildNoShowMessage({
  ...
  if (futureAppointments.length > 0) {
    ...
    return [
      `Hi ${firstName}, we missed you today (${missedLabel}) with ${providerName}.`,
  ...
  if (matchingSlots.length > 0) {
    ...
    const prefNote = preferredDays.length > 0
      ...
      : ''
    return [
      `Hi ${firstName}, we noticed you missed your appointment on ${missedLabel}.`,
  ...
  if (openSlots.length > 0) {
    ...
    return [
      `Hi ${firstName}, we missed you at your appointment on ${missedLabel}.`,
  ...
  return [
    `Hi ${firstName}, we missed you at your appointment on ${missedLabel} with ${providerName}.`,
